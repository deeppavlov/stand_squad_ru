...
train_file = os.path.join(home,  "datasets", "sbersquad", "train_dev-v1.1.json")
dev_file = os.path.join(home, "datasets", "sbersquad", "dev-v1.1.json")
test_file = os.path.join(home, "datasets", "sbersquad", "dev-v1.1.json")
predict_file = os.path.join(home, "datasets", "sbersquad", "task_private.json_squad")
glove_word_file = os.path.join(home, "data", "glove", "glove.840B.300d.txt")

suff = "char_300_pretrained_train_full"
...
glove_char_file = os.path.join(home, "datasets", "ft_native_300_ru_wiki_lenta_nltk_word_tokenize-char.vec")
...
fasttext_file = os.path.join(home, "datasets", "ft_native_300_ru_wiki_lenta_nltk_word_tokenize.vec")
